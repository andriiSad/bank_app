...
class _RecieverPhoto extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final downloadUrl =
        context.watch<TransferCubit>().state.recieverUser?.photoUrl;
    return Container(
      height: 100,
      width: 100,
...
class _RecieverUsername extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final username =
        context.watch<TransferCubit>().state.recieverUser?.username ?? '';
    return Text(
      username,
...
class __SenderCardMenuState extends State<_SenderCardMenu> {
  ...
  @override
  Widget build(BuildContext context) {
    final bool isStatusInitial =
        context.watch<TransferCubit>().state.status == TransferStatus.initial;
    if (isStatusInitial) {
      selectedCardId = null;
    }
    return Container(
